        ...
        {!played && (
          <div className="mt-4 pt-3 border-t border-white/5">
            <button
              ...
              className="w-full py-2.5 bg-[#f36238]/10 hover:bg-[#f36238]/20 border border-[#f36238]/30 text-[#f36238] font-headline font-bold text-xs uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 active:scale-[0.98]"
            >
