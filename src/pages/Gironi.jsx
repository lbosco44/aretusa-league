      ...
      <main className="pt-24 pb-32 px-4 max-w-5xl mx-auto">
        ...
        <section className="mb-8">
          <div className="relative h-48 w-full rounded-xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-6 left-6">
              ...
              <p className="text-secondary font-bold tracking-widest text-xs uppercase mt-1">Fase a Gironi • 4 Gruppi • 16 Squadre</p>
            </div>
          </div>
        </section>
        ...
        <div className="flex gap-2 mb-8 bg-[#152040] p-1.5 rounded-xl border border-white/5">
          {LETTERS.map(g => (
            <button
              key={g}
              onClick={() => setActive(g)}
              className={`flex-1 py-3 px-4 rounded-lg font-headline font-bold text-sm tracking-tight transition-all ${
                active === g ? 'bg-[#254E8F] text-secondary' : 'text-on-surface/60 hover:bg-[#1e3368] hover:text-on-surface'
              }`}
            >
              Girone {g}
            </button>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-[#152040] p-6 rounded-2xl flex items-center gap-4 border border-secondary/10">
            ...
            <div>
              <h4 className="font-headline font-black text-sm uppercase tracking-tight text-secondary">Promozione</h4>
              <p className="text-on-surface-variant text-xs font-medium">I primi due di ogni girone accedono alla fase a eliminazione diretta.</p>
            </div>
          </div>
          <div className="bg-[#152040] p-6 rounded-2xl flex items-center gap-4 border border-white/5">
            ...
            <div>
              <h4 className="font-headline font-black text-sm uppercase tracking-tight text-on-surface-variant">Consolazione</h4>
              <p className="text-on-surface-variant text-xs font-medium">I restanti accedono al tabellone Silver del torneo.</p>
            </div>
          </div>
        </div>
      </main>
